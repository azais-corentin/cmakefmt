...
project(glaze VERSION 7.0.1 LANGUAGES CXX)
...
if(MSVC)
  ...
  if(matched_cl)
    ...
    target_compile_options(glaze_glaze
      INTERFACE "/Zc:preprocessor" /permissive- /Zc:lambda
    )

    if(PROJECT_IS_TOP_LEVEL)
      target_compile_options(glaze_glaze
        INTERFACE $<$<CONFIG:Release>:/GL> $<$<CONFIG:MinSizeRel>:/GL>
      )
      target_link_options(glaze_glaze
        INTERFACE 
...
if(glaze_EETF_FORMAT)
  ...
  target_link_libraries(glaze_glaze
    ${warning_guard}
    INTERFACE Erlang::EI Erlang::Erlang
  )
...
if(glaze_ENABLE_SSL)
  ...
  target_link_libraries(glaze_glaze
    ${warning_guard}
    INTERFACE OpenSSL::SSL OpenSSL::Crypto
  )
