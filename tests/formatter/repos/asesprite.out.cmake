...
if(
  NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/laf/CMakeLists.txt"
  OR NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/laf/clip/CMakeLists.txt"
)
  message(FATAL_ERROR
...
if(ENABLE_SENTRY)
  ...
  set(SENTRY_ENV
    "development"
    CACHE STRING
    "Sentry environment (production, testing, development, etc.)"
  )
endif()
...
if(USE_SHARED_PIXMAN)
  ...
  set(PIXMAN_INCLUDE_DIR ${PIXMAN_DIR}/pixman ${CMAKE_BINARY_DIR}) # For pixman-version.h
endif()
