...
# ---[ Options.
set(XNNPACK_LIBRARY_TYPE "default"
  CACHE STRING "Type of library (shared, static, or default) to build"
)
...
option(XNNPACK_ENABLE_MEMOPT
  "Build XNNPACK with optimized memory allocation scheme"
  ON
)
option(XNNPACK_ENABLE_SPARSE
  "Build XNNPACK with graph rewriting for sparse inference"
  ON
)
option(XNNPACK_BUILD_TESTS "Build XNNPACK unit tests" OFF)
option(XNNPACK_BUILD_BENCHMARKS "Build XNNPACK benchmarks" OFF)
option(XNNPACK_USE_SYSTEM_LIBS "Use system-provided dependency libraries" OFF)
if(EMSCRIPTEN)
  option(XNNPACK_WITH_WASM_SIMD "Use wasm simd" ON)
else()
  option(XNNPACK_WITH_WASM_SIMD "Use wasm simd" OFF)
endif()
...
elseif(IPHONESIMULATOR_ARCHS)
  set(XNNPACK_TARGET_PROCESSOR "${IPHONESIMULATOR_ARCHS}")
  set(IOS_ARCH "${IPHONESIMULATOR_ARCHS}")
elseif(CMAKE_SYSTEM_NAME STREQUAL "iOS" AND IPHONEOS_ARCHS MATCHES "^(x86_64|arm64|arm64e)$")
  set(XNNPACK_TARGET_PROCESSOR "${IPHONEOS_ARCHS}")
endif()

message("===================CMAKE_SYSTEM_NAME: " ${CMAKE_SYSTEM_NAME})
message("===================IPHONEOS_ARCHS: " ${IPHONEOS_ARCHS})
message("===================IPHONESIMULATOR_ARCHS: " ${IPHONESIMULATOR_ARCHS})
message("===================XNNPACK_TARGET_PROCESSOR "
  ${XNNPACK_TARGET_PROCESSOR}
)
...
if(NOT CMAKE_SYSTEM_PROCESSOR)
  if(IOS)
    ...
    if(IOS_ARCH_COUNT GREATER 1)
      message(FATAL_ERROR
        "Unsupported XNNPACK build with multiple iOS architectures (${IOS_ARCH}). "
...
elseif(NOT XNNPACK_TARGET_PROCESSOR MATCHES "^(i[3-6]86|x86|x86_64|AMD64|armv[5-8].*|aarch64|arm64.*|riscv(32|64|128))$")
  message(FATAL_ERROR
    "Unrecognized XNNPACK_TARGET_PROCESSOR = ${XNNPACK_TARGET_PROCESSOR}"
  )
endif()
...
if(NOT XNNPACK_USE_SYSTEM_LIBS)
  if(NOT DEFINED CLOG_SOURCE_DIR)
    ...
    set(CLOG_SOURCE_DIR "${CMAKE_BINARY_DIR}/clog-source"
      CACHE STRING "clog source directory"
    )
  endif()
  ...
  if(NOT DEFINED CPUINFO_SOURCE_DIR)
    ...
    set(CPUINFO_SOURCE_DIR "${CMAKE_BINARY_DIR}/cpuinfo-source"
  ...
  if(NOT DEFINED FP16_SOURCE_DIR)
    ...
    set(FP16_SOURCE_DIR "${CMAKE_BINARY_DIR}/FP16-source"
  ...
  if(NOT DEFINED FXDIV_SOURCE_DIR)
    ...
    set(FXDIV_SOURCE_DIR "${CMAKE_BINARY_DIR}/FXdiv-source"
  ...
  if(NOT DEFINED PTHREADPOOL_SOURCE_DIR)
    ...
    set(PTHREADPOOL_SOURCE_DIR "${CMAKE_BINARY_DIR}/pthreadpool-source"
  ...
  if(XNNPACK_BUILD_BENCHMARKS AND NOT DEFINED GOOGLEBENCHMARK_SOURCE_DIR)
    ...
    set(GOOGLEBENCHMARK_SOURCE_DIR "${CMAKE_BINARY_DIR}/googlebenchmark-source"
      CACHE STRING "Google Benchmark source directory"
    )
  endif()
endif()
...
set(XNNPACK_COLD_SRCS
  ${XNNPACK_OPERATOR_SRCS}
  ${XNNPACK_SUBGRAPH_SRCS}
  ${XNNPACK_LOGGING_SRCS}
)
list(
  APPEND XNNPACK_COLD_SRCS
  src/allocator.c
  src/init.c
...
set(XNNPACK_HOT_SRCS src/indirection.c src/operator-run.c src/packing.c)
...
set(WASMSIMD_UKERNELS
  ...
  src/f32-vsigmoid/gen/vsigmoid-wasmsimd-lut64-p2-div-x4.c
  src/f32-vsigmoid/gen/vsigmoid-wasmsimd-lut64-p2-div-x8.c
  src/f32-vsigmoid/gen/vsigmoid-wasmsimd-lut64-p2-div-x12.c
  src/f32-vsigmoid/gen/vsigmoid-wasmsimd-lut64-p2-div-x16.c
  src/f32-vsigmoid/gen/vsigmoid-wasmsimd-lut64-p2-div-x20.c
  src/f32-vsigmoid/gen/vsigmoid-wasmsimd-lut64-p2-div-x24.c
  src/f32-vsigmoid/gen/vsigmoid-wasmsimd-p5-div-x4.c
  src/f32-vsigmoid/gen/vsigmoid-wasmsimd-p5-div-x8.c
  src/f32-vsigmoid/gen/vsigmoid-wasmsimd-p5-div-x12.c
  src/f32-vsigmoid/gen/vsigmoid-wasmsimd-p5-div-x16.c
  src/f32-vsigmoid/gen/vsigmoid-wasmsimd-p5-div-x20.c
  src/f32-vsigmoid/gen/vsigmoid-wasmsimd-p5-div-x24.c
  ...
  src/qc8-gemm/gen/1x4c8-minmax-fp32-wasmsimd-ld64.c
  src/qc8-gemm/gen/1x4c8-minmax-fp32-wasmsimd-ld128.c
  src/qc8-gemm/gen/2x4c8-minmax-fp32-wasmsimd-ld64.c
  src/qc8-gemm/gen/2x4c8-minmax-fp32-wasmsimd-ld128.c
  src/qc8-gemm/gen/3x4c8-minmax-fp32-wasmsimd-ld64.c
  src/qc8-gemm/gen/3x4c8-minmax-fp32-wasmsimd-ld128.c
  src/qc8-igemm/gen/1x4c8-minmax-fp32-wasmsimd-ld64.c
  src/qc8-igemm/gen/1x4c8-minmax-fp32-wasmsimd-ld128.c
  src/qc8-igemm/gen/2x4c8-minmax-fp32-wasmsimd-ld64.c
  src/qc8-igemm/gen/2x4c8-minmax-fp32-wasmsimd-ld128.c
  src/qc8-igemm/gen/3x4c8-minmax-fp32-wasmsimd-ld64.c
  src/qc8-igemm/gen/3x4c8-minmax-fp32-wasmsimd-ld128.c
  src/qs8-dwconv/gen/up8x9-minmax-fp32-wasmsimd-mul16.c
  src/qs8-dwconv/gen/up8x9-minmax-gemmlowp-wasmsimd-mul16.c
  src/qs8-dwconv/gen/up8x25-minmax-fp32-wasmsimd-mul16.c
  src/qs8-dwconv/gen/up8x25-minmax-gemmlowp-wasmsimd-mul16.c
  src/qs8-dwconv/gen/up16x9-minmax-fp32-wasmsimd-mul16.c
  src/qs8-dwconv/gen/up16x9-minmax-gemmlowp-wasmsimd-mul16.c
  src/qs8-dwconv/gen/up16x25-minmax-fp32-wasmsimd-mul16.c
  src/qs8-dwconv/gen/up16x25-minmax-gemmlowp-wasmsimd-mul16.c
  src/qs8-dwconv/gen/up24x9-minmax-fp32-wasmsimd-mul16.c
  src/qs8-dwconv/gen/up24x9-minmax-gemmlowp-wasmsimd-mul16.c
  src/qs8-dwconv/gen/up24x25-minmax-fp32-wasmsimd-mul16.c
  src/qs8-dwconv/gen/up24x25-minmax-gemmlowp-wasmsimd-mul16.c
  ...
  src/qu8-gemm/gen/1x4c8-minmax-fp32-wasmsimd-ld64.c
  src/qu8-gemm/gen/1x4c8-minmax-fp32-wasmsimd-ld128.c
  src/qu8-gemm/gen/2x4c8-minmax-fp32-wasmsimd-ld64.c
  src/qu8-gemm/gen/2x4c8-minmax-fp32-wasmsimd-ld128.c
  src/qu8-gemm/gen/3x4c8-minmax-fp32-wasmsimd-ld64.c
  src/qu8-gemm/gen/3x4c8-minmax-fp32-wasmsimd-ld128.c
  src/qu8-igemm/gen/1x4c8-minmax-fp32-wasmsimd-ld64.c
  src/qu8-igemm/gen/1x4c8-minmax-fp32-wasmsimd-ld128.c
  src/qu8-igemm/gen/2x4c8-minmax-fp32-wasmsimd-ld64.c
  src/qu8-igemm/gen/2x4c8-minmax-fp32-wasmsimd-ld128.c
  src/qu8-igemm/gen/3x4c8-minmax-fp32-wasmsimd-ld64.c
...
if(CMAKE_SYSTEM_PROCESSOR MATCHES "^armv[5-8]" OR IOS_ARCH MATCHES "^armv7")
  ...
  if(XNNPACK_ENABLE_ASSEMBLY)
    list(
      APPEND XNNPACK_MICROKERNEL_SRCS
      ${XNNPACK_AARCH32_ASM_MICROKERNEL_SRCS}
    )
  endif()
endif()
if(XNNPACK_TARGET_PROCESSOR MATCHES "^(aarch64|arm64)$" OR IOS_ARCH MATCHES "^arm64.*")
  ...
  list(
    APPEND XNNPACK_MICROKERNEL_SRCS
    ${XNNPACK_AARCH64_NEONFMA_MICROKERNEL_SRCS}
  )
  list(
    APPEND XNNPACK_MICROKERNEL_SRCS
    ${XNNPACK_AARCH64_NEONFP16ARITH_MICROKERNEL_SRCS}
  )
  list(APPEND XNNPACK_MICROKERNEL_SRCS ${XNNPACK_NEONDOT_MICROKERNEL_SRCS})
  if(XNNPACK_ENABLE_ASSEMBLY)
    list(
      APPEND XNNPACK_MICROKERNEL_SRCS
      ${XNNPACK_AARCH64_ASM_MICROKERNEL_SRCS}
    )
  endif()
endif()
...
if(EMSCRIPTEN)
  list(APPEND XNNPACK_MICROKERNEL_SRCS ${WASM_UKERNELS})
  list(APPEND XNNPACK_MICROKERNEL_SRCS ${WASM32_ASM_UKERNELS})
  if(XNNPACK_WITH_WASM_SIMD)
    list(APPEND XNNPACK_MICROKERNEL_SRCS ${WASMSIMD_UKERNELS})
  endif()
endif()
...
if(CMAKE_SYSTEM_PROCESSOR MATCHES "^armv[5-8]" OR IOS_ARCH MATCHES "^armv7")
  set_property(
    ...
    APPEND_STRING
    PROPERTY COMPILE_FLAGS " -marm "
  )
  set_property(
    SOURCE ${XNNPACK_NEON_MICROKERNEL_SRCS}
    APPEND_STRING
    PROPERTY COMPILE_FLAGS " -march=armv7-a -mfpu=neon "
  )
  set_property(
    SOURCE ${XNNPACK_NEONFMA_MICROKERNEL_SRCS}
    APPEND_STRING
    PROPERTY COMPILE_FLAGS " -march=armv7-a -mfpu=neon-vfpv4 "
  )
  if(IOS)
    set_property(
      SOURCE ${XNNPACK_NEONV8_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " -mcpu=cyclone -mtune=generic "
    )
    set_property(
      SOURCE ${XNNPACK_AARCH32_ASM_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " ${IOS_ARCH} "
    )
  elseif(NOT CMAKE_SYSTEM_NAME MATCHES "Linux")
    message("====================== Enable armv8-a")
    set_property(
      SOURCE ${XNNPACK_NEONV8_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " -march=armv8-a -mfpu=neon-fp-armv8 "
    )
    set_property(
      SOURCE ${XNNPACK_NEONDOT_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " -march=armv8.2-a+dotprod -mfpu=neon-fp-armv8 "
    )
  endif()
  ...
  if(ANDROID_NDK_MAJOR AND ANDROID_NDK_MAJOR LESS 21)
    set_property(
      SOURCE ${XNNPACK_NEONV8_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " -mfloat-abi=softfp "
    )
    set_property(
      SOURCE ${XNNPACK_NEONDOT_MICROKERNEL_SRCS}
      APPEND_STRING
...
if(XNNPACK_TARGET_PROCESSOR MATCHES "^(aarch64|arm64)$" OR IOS_ARCH MATCHES "^arm64.*")
  set_property(
    SOURCE ${XNNPACK_AARCH64_NEONFP16ARITH_MICROKERNEL_SRCS}
    APPEND_STRING
    PROPERTY COMPILE_FLAGS " -march=armv8.2-a+fp16 "
  )
  set_property(
    SOURCE ${XNNPACK_NEONDOT_MICROKERNEL_SRCS}
    APPEND_STRING
    PROPERTY COMPILE_FLAGS " -march=armv8.2-a+dotprod "
  )
  set_property(
    SOURCE ${XNNPACK_AARCH64_ASM_MICROKERNEL_SRCS}
    APPEND_STRING
    PROPERTY COMPILE_FLAGS " -march=armv8.2-a+fp16+dotprod "
  )
  if(IOS)
    set_property(
      SOURCE ${XNNPACK_AARCH64_ASM_MICROKERNEL_SRCS}
  ...
  if(XNNPACK_TARGET_PROCESSOR STREQUAL "arm64" AND CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL "x86_64")
    set_property(
      SOURCE ${XNNPACK_AARCH64_ASM_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " -arch arm64 "
    )
  endif()
endif()
if(XNNPACK_TARGET_PROCESSOR MATCHES "^(i[3-6]86|x86|x86_64|AMD64)$" OR IOS_ARCH MATCHES "^(i386|x86_64|AMD64)$")
  if(MSVC)
    if(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86" OR CMAKE_SIZEOF_VOID_P EQUAL 4)
      set_property(
        SOURCE ${XNNPACK_SSE_MICROKERNEL_SRCS}
        APPEND_STRING
        PROPERTY COMPILE_FLAGS " /arch:SSE "
      )
      set_property(
        SOURCE ${XNNPACK_SSE2_MICROKERNEL_SRCS}
        APPEND_STRING
        PROPERTY COMPILE_FLAGS " /arch:SSE2 "
      )
      set_property(
        SOURCE ${XNNPACK_SSSE3_MICROKERNEL_SRCS}
        APPEND_STRING
        PROPERTY COMPILE_FLAGS " /arch:SSE2 "
      )
      set_property(
        SOURCE ${XNNPACK_SSE41_MICROKERNEL_SRCS}
        APPEND_STRING
        PROPERTY COMPILE_FLAGS " /arch:SSE2 "
      )
    endif()
    set_property(
      SOURCE ${XNNPACK_AVX_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " /arch:AVX "
    )
    set_property(
      SOURCE ${XNNPACK_XOP_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " /arch:AVX "
    )
    set_property(
      SOURCE ${XNNPACK_FMA3_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " /arch:AVX "
    )
    set_property(
      SOURCE ${XNNPACK_AVX2_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " /arch:AVX2 "
    )
    set_property(
      SOURCE ${XNNPACK_AVX512F_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " /arch:AVX512 "
    )
    set_property(
      SOURCE ${XNNPACK_AVX512SKX_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " /arch:AVX512 "
    )
  else()
    ...
    set_property(
      SOURCE ${XNNPACK_AVX_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " -mavx "
    )
    set_property(
      SOURCE ${XNNPACK_XOP_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " -mxop "
    )
    set_property(
      SOURCE ${XNNPACK_FMA3_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " -mfma "
    )
    set_property(
      SOURCE ${XNNPACK_AVX2_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " -mfma -mavx2 "
    )
    set_property(
      SOURCE ${XNNPACK_AVX512F_MICROKERNEL_SRCS}
      APPEND_STRING
    ...
    set_property(
      SOURCE ${XNNPACK_AVX512SKX_MICROKERNEL_SRCS} APPEND_STRIDE
      PROPERTY
        COMPILE_FLAGS " -mavx512f -mavx512cd -mavx512bw -mavx512dq -mavx512vl "
    )
    if(MINGW OR CMAKE_SYSTEM_NAME MATCHES "^(CYGWIN|MSYS)$")
      ...
      set_property(
        SOURCE ${XNNPACK_AVX512F_MICROKERNEL_SRCS}
        APPEND_STRING
        PROPERTY COMPILE_FLAGS " -fno-asynchronous-unwind-tables "
      )
      set_property(
        SOURCE ${XNNPACK_AVX512SKX_MICROKERNEL_SRCS}
        APPEND_STRING
...
if(MSVC)
  ...
  if(NOT CMAKE_BUILD_TYPE STREQUAL "Debug")
    ...
    set_property(
      SOURCE ${XNNPACK_HOT_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " /O2 "
    )
    set_property(
      SOURCE ${XNNPACK_COLD_SRCS}
      APPEND_STRING
...
if(EMSCRIPTEN)
  if(XNNPACK_WITH_WASM_SIMD)
    set_property(
      SOURCE ${XNNPACK_MICROKERNEL_SRCS}
      APPEND_STRING
      PROPERTY COMPILE_FLAGS " -msimd128 "
    )
    set_property(
      TARGET XNNPACK
      APPEND_STRING
...
if(NOT TARGET clog)
  if(NOT XNNPACK_USE_SYSTEM_LIBS)
    ...
    add_subdirectory("${CLOG_SOURCE_DIR}/deps/clog" "${CMAKE_BINARY_DIR}/clog")
...
if(NOT TARGET cpuinfo)
  if(NOT XNNPACK_USE_SYSTEM_LIBS)
    ...
    add_subdirectory("${CPUINFO_SOURCE_DIR}" "${CMAKE_BINARY_DIR}/cpuinfo")
  else()
...
if(NOT TARGET pthreadpool)
  if(NOT XNNPACK_USE_SYSTEM_LIBS)
    ...
    set_property(
      TARGET pthreadpool
      PROPERTY IMPORTED_LOCATION "${PTHREADPOOL_LIBRARY}"
    )
  endif()
endif()
...
if(NOT TARGET fxdiv)
  if(NOT XNNPACK_USE_SYSTEM_LIBS)
    ...
    add_subdirectory("${FXDIV_SOURCE_DIR}" "${CMAKE_BINARY_DIR}/FXdiv")
  else()
...
if(NOT TARGET fp16)
  if(NOT XNNPACK_USE_SYSTEM_LIBS)
    ...
    add_subdirectory("${FP16_SOURCE_DIR}" "${CMAKE_BINARY_DIR}/FP16")
  else()
...
if(XNNPACK_BUILD_TESTS)
  ...
  set_target_properties(operator-size-test
    PROPERTIES C_STANDARD 99 C_EXTENSIONS NO
  )
  target_link_libraries(operator-size-test PRIVATE XNNPACK)

  add_executable(subgraph-size-test test/subgraph-size.c)
  set_target_properties(subgraph-size-test
    PROPERTIES C_STANDARD 99 C_EXTENSIONS NO
  )
  ...
  set_target_properties(abs-nc-test
  ...
  set_target_properties(add-nd-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(argmax-pooling-nhwc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  target_include_directories(argmax-pooling-nhwc-test PRIVATE src test)
  target_link_libraries(argmax-pooling-nhwc-test
    PRIVATE XNNPACK gtest gtest_main
  )
  ...
  set_target_properties(average-pooling-nhwc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  target_include_directories(average-pooling-nhwc-test PRIVATE src test)
  target_link_libraries(average-pooling-nhwc-test
    PRIVATE XNNPACK gtest gtest_main
  )
  ...
  set_target_properties(constant-pad-nd-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(convolution-nhwc-test
  ...
  set_target_properties(deconvolution-nhwc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  target_include_directories(deconvolution-nhwc-test PRIVATE src test)
  target_link_libraries(deconvolution-nhwc-test
    PRIVATE XNNPACK gtest gtest_main
  )
  add_test(deconvolution-nhwc-test deconvolution-nhwc-test)

  add_executable(depth-to-space-nchw2nhwc-test
    test/depth-to-space-nchw2nhwc.cc
  )
  set_target_properties(depth-to-space-nchw2nhwc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  target_include_directories(depth-to-space-nchw2nhwc-test PRIVATE src test)
  target_link_libraries(depth-to-space-nchw2nhwc-test
    PRIVATE XNNPACK gtest gtest_main
  )
  ...
  set_target_properties(elu-nc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  add_executable(global-average-pooling-nwc-test
    test/global-average-pooling-nwc.cc
  )
  set_target_properties(global-average-pooling-nwc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  target_include_directories(global-average-pooling-nwc-test PRIVATE src test)
  target_link_libraries(global-average-pooling-nwc-test
    PRIVATE XNNPACK fp16 gtest gtest_main
  )
  add_test(global-average-pooling-nwc-test global-average-pooling-nwc-test)

  add_executable(global-average-pooling-ncw-test
    test/global-average-pooling-ncw.cc
  )
  set_target_properties(global-average-pooling-ncw-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  target_include_directories(global-average-pooling-ncw-test PRIVATE src test)
  target_link_libraries(global-average-pooling-ncw-test
    PRIVATE XNNPACK fp16 gtest gtest_main
  )
  ...
  set_target_properties(hardswish-nc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(leaky-relu-nc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(max-pooling-nhwc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(maximum-nd-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(minimum-nd-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(multiply-nd-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(negate-nc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(prelu-nc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(resize-bilinear-nhwc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  target_include_directories(resize-bilinear-nhwc-test PRIVATE src test)
  target_link_libraries(resize-bilinear-nhwc-test
    PRIVATE XNNPACK gtest gtest_main
  )
  ...
  set_target_properties(softmax-nc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(square-nc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(square-root-nc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(truncation-nc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(unpooling-nhwc-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(memory-planner-test
    PROPERTIES C_STANDARD 11 CXX_STANDARD_REQUIRED YES C_EXTENSIONS NO
  )
  ...
  set_target_properties(subgraph-nchw-test
    PROPERTIES C_STANDARD 11 CXX_STANDARD_REQUIRED YES C_EXTENSIONS NO
  )
  ...
  set_target_properties(f16-dwconv-minmax-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  target_include_directories(f16-dwconv-minmax-test PRIVATE src test)
  target_link_libraries(f16-dwconv-minmax-test
    PRIVATE XNNPACK cpuinfo fp16 gtest gtest_main
  )
  ...
  set_target_properties(qc8-dwconv-minmax-fp32-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  target_include_directories(qc8-dwconv-minmax-fp32-test PRIVATE src test)
  target_link_libraries(qc8-dwconv-minmax-fp32-test
    PRIVATE XNNPACK cpuinfo fp16 gtest gtest_main
  )
  ...
  set_target_properties(qc8-gemm-minmax-fp32-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  target_include_directories(qc8-gemm-minmax-fp32-test PRIVATE src test)
  target_link_libraries(qc8-gemm-minmax-fp32-test
    PRIVATE XNNPACK cpuinfo fp16 gtest gtest_main
  )
  ...
  set_target_properties(qc8-igemm-minmax-fp32-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  target_include_directories(qc8-igemm-minmax-fp32-test PRIVATE src test)
  target_link_libraries(qc8-igemm-minmax-fp32-test
    PRIVATE XNNPACK cpuinfo fp16 gtest gtest_main
  )
  ...
  set_target_properties(qs8-dwconv-minmax-fp32-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  target_include_directories(qs8-dwconv-minmax-fp32-test PRIVATE src test)
  target_link_libraries(qs8-dwconv-minmax-fp32-test
    PRIVATE XNNPACK cpuinfo fp16 gtest gtest_main
  )
  add_test(qs8-dwconv-minmax-fp32-test qs8-dwconv-minmax-fp32-test)

  add_executable(qs8-dwconv-minmax-gemmlowp-test
    test/qs8-dwconv-minmax-gemmlowp.cc
  )
  set_target_properties(qs8-dwconv-minmax-gemmlowp-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  target_include_directories(qs8-dwconv-minmax-gemmlowp-test PRIVATE src test)
  target_link_libraries(qs8-dwconv-minmax-gemmlowp-test
    PRIVATE XNNPACK cpuinfo fp16 gtest gtest_main
  )
  ...
  set_target_properties(qs8-dwconv-minmax-rndnu-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  target_include_directories(qs8-dwconv-minmax-rndnu-test PRIVATE src test)
  target_link_libraries(qs8-dwconv-minmax-rndnu-test
    PRIVATE XNNPACK cpuinfo fp16 gtest gtest_main
  )
  ...
  set_target_properties(qs8-gemm-minmax-rndnu-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  target_include_directories(qs8-gemm-minmax-rndnu-test PRIVATE src test)
  target_link_libraries(qs8-gemm-minmax-rndnu-test
    PRIVATE XNNPACK cpuinfo fp16 gtest gtest_main
  )
  ...
  set_target_properties(qs8-igemm-minmax-fp32-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  target_include_directories(qs8-igemm-minmax-fp32-test PRIVATE src test)
  target_link_libraries(qs8-igemm-minmax-fp32-test
    PRIVATE XNNPACK cpuinfo fp16 gtest gtest_main
  )
  add_test(qs8-igemm-minmax-fp32-test qs8-igemm-minmax-fp32-test)

  add_executable(qs8-igemm-minmax-gemmlowp-test
    test/qs8-igemm-minmax-gemmlowp.cc
  )
  set_target_properties(qs8-igemm-minmax-gemmlowp-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  target_include_directories(qs8-igemm-minmax-gemmlowp-test PRIVATE src test)
  target_link_libraries(qs8-igemm-minmax-gemmlowp-test
    PRIVATE XNNPACK cpuinfo fp16 gtest gtest_main
  )
  ...
  set_target_properties(qs8-igemm-minmax-rndnu-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  target_include_directories(qs8-igemm-minmax-rndnu-test PRIVATE src test)
  target_link_libraries(qs8-igemm-minmax-rndnu-test
    PRIVATE XNNPACK cpuinfo fp16 gtest gtest_main
  )
  ...
  set_target_properties(qu8-dwconv-minmax-fp32-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  target_include_directories(qu8-dwconv-minmax-fp32-test PRIVATE src test)
  target_link_libraries(qu8-dwconv-minmax-fp32-test
    PRIVATE XNNPACK cpuinfo fp16 gtest gtest_main
  )
  ...
  set_target_properties(qu8-igemm-minmax-fp32-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  target_include_directories(qu8-igemm-minmax-fp32-test PRIVATE src test)
  target_link_libraries(qu8-igemm-minmax-fp32-test
    PRIVATE XNNPACK cpuinfo fp16 gtest gtest_main
  )
  add_test(qu8-igemm-minmax-fp32-test qu8-igemm-minmax-fp32-test)

  add_executable(qu8-igemm-minmax-gemmlowp-test
    test/qu8-igemm-minmax-gemmlowp.cc
  )
  set_target_properties(qu8-igemm-minmax-gemmlowp-test
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  target_include_directories(qu8-igemm-minmax-gemmlowp-test PRIVATE src test)
  target_link_libraries(qu8-igemm-minmax-gemmlowp-test
    PRIVATE XNNPACK cpuinfo fp16 gtest gtest_main
  )
...
if(XNNPACK_BUILD_BENCHMARKS)
  ...
  set_target_properties(bench-utils
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(bench-models
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(elu-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(floor-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(prelu-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS NO
  )
  ...
  set_target_properties(f16-dwconv-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f16-gemm-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f16-igemm-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f16-vrelu-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f32-conv-hwc-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f32-dwconv-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f32-dwconv2d-chw-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f32-gemm-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f32-igemm-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f32-im2col-gemm-bench
    PROPERTIES
      C_STANDARD 99
  ...
  set_target_properties(f32-rmax-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f32-spmm-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f32-softmax-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f32-velu-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f32-vhswish-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f32-vrelu-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f32-vsigmoid-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(f32-vsqrt-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(qs8-gemm-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(qs8-requantization-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(qu8-gemm-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(qu8-requantization-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
  ...
  set_target_properties(rounding-bench
    PROPERTIES CXX_STANDARD 11 CXX_STANDARD_REQUIRED YES CXX_EXTENSIONS YES
  )
